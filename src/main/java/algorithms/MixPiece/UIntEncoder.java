...
class UIntEncoder {
    protected static void write(long number, ByteArrayOutputStream outputStream) throws IOException {
    ...
    protected static long read(ByteArrayInputStream inputStream) throws IOException {
