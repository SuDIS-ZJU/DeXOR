...
public class DoubleCamelDecoder extends Decoder {
    ...
    public DoubleCamelDecoder(String inputPath, String config) {
    ...
    public double decodeDouble() {
        ...
        if (first) {
            ...
            // Keep the decoder state identical to the encoder for negative values.
            // The encoder splits every value with floor(), not truncation toward zero.
            previous_integer = (long) Math.floor(value);
            first = false;
        } else {
