package algorithms.Elf.encoder;
...
public class DoubleElfEncoder extends Encoder {
    ...
    public DoubleElfEncoder(String outputPath, String config) {
        super(outputPath, config);
    }

    protected long eraser(double v) {
        ...
        if (betaStar < 16 && delta != 0 && eraseBits > 4) {
            out.write(alphaAndBetaStar[1] | 0x10, 5);
